...
class Config:
    ...
    GOOGLE_CLOUD_PROJECT_NUMBER = _env("GOOGLE_CLOUD_PROJECT_NUMBER", "818451146944")
    GOOGLE_DRIVE_POLL_INTERVAL_SECONDS = int(_env("GOOGLE_DRIVE_POLL_INTERVAL_SECONDS", "30"))
