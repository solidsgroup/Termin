...
def _serialize_task_payload(task: Task, *, action: str = "updated", old_project_id: int | None = None, old_group_id: int | None = None) -> dict:
    return {
        "action": action,
        "task": {
            "id": task.id,
...
def _serialize_subtask_payload(task: Task, subtask: Subtask, *, action: str = "updated") -> dict:
    return {
        "action": action,
        "task": {
            "id": task.id,
...
def emit_task_updated(task: Task, *, action: str = "updated", old_project_id: int | None = None, old_group_id: int | None = None) -> None:
    payload = _serialize_task_payload(task, action=action, old_project_id=old_project_id, old_group_id=old_group_id)
...
def emit_subtask_updated(task: Task, subtask: Subtask, *, action: str = "updated") -> None:
    payload = _serialize_subtask_payload(task, subtask, action=action)
